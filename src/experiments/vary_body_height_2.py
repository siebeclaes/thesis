...
EXPERIMENT_TAG = 'vary_body_height_2'
NUM_OPTIMIZATION_STEPS = 200
E_0 = 30
NUM_VARIATIONS = 15

def perform_experiment(body_height_variance):
	from Experiment import Experiment
	variation_params_spring = {'body': {
		'height': {'normal': [0, body_height_variance]},
		},
	}
	...
	e = Experiment(model_config, False, initial, lb, ub, 0.5, NUM_OPTIMIZATION_STEPS, E_0, variation_params=variation_params_spring, num_variations=NUM_VARIATIONS, perturbation_params=None, experiment_tag=EXPERIMENT_TAG, experiment_tag_index=body_height_variance)
	e.run()
...
def test_results():
	...
	plt.xlabel('Body height standard deviation')
	plt.ylabel('Reward')
	plt.legend()
