...
def speed_vs_cot(simulations, folder):
	...
	plt.xlabel('Cost of transport (power / speed)')
...
def cot_vs_pref(simulations, folder):
	...
	plt.ylabel('Cost of transport (power / speed)')
...
def main():
	folders = ['correct_uniform', 'correct_inertia']
	...
	plt.tight_layout()
	plt.savefig(os.path.join('/Users/Siebe/Dropbox/Thesis/writing/abstract/figures/abstract_speed_cot.png'), dpi=300)
