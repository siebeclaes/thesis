...
EXPERIMENT_TAG = 'vary_tibia_length_1'
NUM_OPTIMIZATION_STEPS = 150
E_0 = 30
NUM_VARIATIONS = 15

def perform_experiment(tibia_length_variance):

	print('Experiment "' + EXPERIMENT_TAG + '": ' + str(tibia_length_variance))
	...
	e = Experiment(model_config, False, initial, lb, ub, 0.5, NUM_OPTIMIZATION_STEPS, E_0, variation_params=variation_params_spring, num_variations=NUM_VARIATIONS, perturbation_params=None, experiment_tag=EXPERIMENT_TAG, experiment_tag_index=tibia_length_variance)
	e.run()
