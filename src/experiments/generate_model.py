...
class Leg(object):
	...
	def calc_morphology(self):
		...
		self.tibia_foot2 = Point(0, tibia_foot_2_y, tibia_foot_2_z)
	...
	def generate_xml_leg(self, x, y, z):
		...
		foot_geom = etree.Element('geom', friction='1 0.005 0.0001', type='capsule', fromto=self.tibia_foot.get_rescaled_text() + ' ' + self.tibia_foot2.get_rescaled_text(), size='0.1')
